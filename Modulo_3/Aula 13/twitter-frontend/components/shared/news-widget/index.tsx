...
const NewsWidget: React.FC = () => {
    return <div className="widget">
        ...
        <NewsItem image="images/react.png" title="React com hooks é incrível!" date={new Date('2020-7-8 20:40')} />
        <NewsItem image="images/react.png" title="React vs Vue" date={new Date('2020-7-8 20:40')} />
        <NewsItem image="images/react.png" title="Quando usar o NextJS?" date={new Date('2020-7-8 20:40')} />
        <NewsItem image="images/react.png" title="Vanilla Typescript faz sentido?" date={new Date('2020-7-8 20:40')} />
