...
export const tweets: ITweet[] = [
  {
    ...
    description:
      "Oie, vou criar um clone do Twitter, vamos?",
  ...
  {
    id: String(Math.random() * 100000),
    description: ` Nossos alunos vão criar páginas incriveis com o <a href="https://nextjs.org/" target="_blank" class='mention'>@nextjs</a> & 
  ...
  {
    id: String(Math.random() * 100000),
    description: `Sim, somos demais! É verdade o bilhete!`,
  ...
  {
    id: String(Math.random() * 100000),
    description: `Novas atualizações em breve, garantimos que vem novidade!`,
    username: "vercel",
    name: "Vercel",
